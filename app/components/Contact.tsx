    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <form onSubmit={ handleSubmit } className="max-w-2xl mx-auto">
                ...
                <textarea rows={6} placeholder="Enter your message" required className="w-full p-4 outline-none border-[0.5px] border-gray-400 rouned-md bg-white mb-6" name="message"></textarea>
                <button type="submit" className="py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500"> Send <Send className="w-5 h-5 text-white" /></button>
